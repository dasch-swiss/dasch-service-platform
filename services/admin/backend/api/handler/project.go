...
// migrateProject creates a project with the ability to specify the short code, which is normally auto-generated.
// This is a temporary method for data migration from the old system to the new system.
